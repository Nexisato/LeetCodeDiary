...
operations for a fixed rotation of operations: multiply (*), divide (/), add (+) and subtract (-) 
in this order.
...
steps before any addition or subtraction steps, and multiplication and division steps are 
