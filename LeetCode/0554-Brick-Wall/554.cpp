...
some number of bricks each of the same height (i.e., one unit) but they can be of
...
goes through the edge of a brick, then the brick is not considered as crossed. You
cannot draw a line just along one of the two vertical edges of the wall, in which case
