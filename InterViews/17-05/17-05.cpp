...
Return the subarray. If there are more than one answer, return the one which has the smallest index of its left
...
-- 若当前位置前缀和 sum 在哈希表中存在，记录 s 第一次出现的位置为 j ，则 [j+1, i] 的子数组和为 0，若 max < i - j,
更新，startI = j + 1
